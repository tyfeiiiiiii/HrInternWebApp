...
namespace HrInternWebApp.Entity
{
    public class Survey
    {
        ...
        public virtual int AverageMonthlyHours { get; set; }  // Integer
        //public virtual int TimeSpendCompany { get; set; }  // Integer
        public virtual int WorkAccident { get; set; }  
        public virtual int PromotionLast5Years { get; set; }  // Boolean
        public virtual string Department { get; set; }  // String (department name)
        public virtual string Salary { get; set; }  // String (salary category or label)
